...
Evaluating such designs is not straightforward, since borrowing breaks the frequentist guarantee of strict type one error (T1E) control. To address this,
...
introduces an analogous average power, derives closed form expressions for both metrics under normal priors, obtains a closed form sample size formula
