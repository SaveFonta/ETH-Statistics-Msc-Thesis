...
patients, but it costs the frequentist guarantee that the type I error (T1E)
...
over a design prior for the control parameter to obtain the \textit{average T1E rate} (avgT1E).
Applying the same averaging to power gives an \textit{average power} (avgPower), and closed form expressions and
