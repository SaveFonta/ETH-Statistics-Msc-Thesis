...
$$
    \sigma_{\text{post}}^2 = \left( \frac{1}{\sigma_{A,C}^2} + \frac{1}{v_C^2} \right)^{-1} = \frac{\sigma_{A,C}^2 v_C^2}{\sigma_{A,C}^2 + v_C^2},
$$
and: 
$$
...
\begin{align*}
    ...
    V_{\delta} &= \sigma_{\text{post}}^2 + v_T^2.
\end{align*}
...
\begin{align}
    \Erw[\hat{\delta} \mid \theta_C, \delta] &= \Erw[\mu_{\text{post}} \mid \theta_C] - \Erw[\bar{y}_T \mid \theta_C, \delta] \nonumber \\
...
\begin{align*}
    ...
    &= \frac{\sigma_{A,C}^2 v_C^2 (\sigma_{A,C}^2 + v_C^2)}{(\sigma_{A,C}^2 + v_C^2)^2} = \frac{\sigma_{A,C}^2 v_C^2}{\sigma_{A,C}^2 + v_C^2} = \sigma_{\text{post}}^2.
\end{align*}
Therefore, $V_{\text{marg}} = \sigma_{\text{post}}^2 + v_T^2$, which is exactly $V_{\delta}$. Substituting these back into Equation~\eqref{eq:app_avgt1e_closed_form}:
$$
