...
characteristics, relying heavily on strict control of the type one error (T1E) rate. A fundamental limitation of this paradigm is that it treats every trial 
...
\begin{itemize}
    \item Building on the average T1E rate (avgT1E), develop an analogous \textit{average power} (avgPower) 
    by integrating the power conditioned on the control parameter over the design prior. Derive closed form 
