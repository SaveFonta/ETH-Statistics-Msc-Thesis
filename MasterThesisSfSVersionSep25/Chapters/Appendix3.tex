...
Section~\ref{sec:calibrated_comparison}. A design whose avgT1E or avgPower falls within two Monte Carlo standard errors
of its calibration target at the higher precision is flagged, since the margin is then too thin to distinguish
from noise.
