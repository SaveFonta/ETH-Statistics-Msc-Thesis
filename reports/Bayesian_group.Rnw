...
\begin{figure}[h]
\centering
<<show-plot, echo=FALSE, fig.width=8, fig.height=6>>=
final_plot_CRON 
@  
...
\begin{figure}[h]
\centering
<<T1E_CRON, echo=FALSE, fig.width=8, fig.height=6>>=
T1E_CRON 
@  
...
\begin{figure}[h]
\centering
<<power_CRON, echo=FALSE, fig.width=8, fig.height=6>>=
Power_plot_CRON 
@  
...
\begin{figure}[h]
\centering
<<EUII_varying_delta_CRON, echo=FALSE, fig.width=8, fig.height=6>>=
EUII_CRON 
@  
...
\subsection{Varying both prior and true value}
Now we inspect what happens when we set the prior = true value, and we make them vary together
...
<<plot_OC_onco, warning=FALSE, echo=FALSE, fig.align='center', fig.width=6.5, fig.height=7.5, fig.cap="Operating Characteristics.", fig.pos="h">>=
OC_onco
@
 
Interestingly, the value of the prior for the alternative, doesnt have much influence here.
<<plot_EUII_onco, warning=FALSE, echo=FALSE, fig.align='center', fig.width=6.5, fig.height=7.5, fig.cap="EUII with varying priors", fig.pos="h">>=
plot_euii_onco
@
...
<<plot_dashboard, warning = FALSE, echo=FALSE, fig.align='center', fig.width=6.5, fig.height=7.5, fig.cap="EUII under varying priors.\\label{fig:euii_dashboard}", fig.pos="h">>=
print(p_final)
@
...
<<plot_oc, warning = FALSE, echo=FALSE, fig.align='center', fig.width=6.5, fig.height=7.5, fig.cap="Cumulative probability of stopping for the Non-Informative and Informative prior designs (plot from the paper)", fig.pos="h">>=
...
<<plot_1, warning = FALSE, echo=FALSE, fig.align='center', fig.width=6.5, fig.height=7.5, fig.cap="Hazard Ratio", fig.pos="h">>=
print(p1_hazard)
@

<<plot_2, warning = FALSE, echo=FALSE, fig.align='center', fig.width=6.5, fig.height=7.5, fig.cap="Hazard Ratio", fig.pos="h">>=
print(p2_hazard)
@
