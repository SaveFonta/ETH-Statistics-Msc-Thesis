...
\]
and $\log\EUII^{\mathrm{DC}}_{\mathrm{avg}} = \big(\Lodd(b_{\mathrm{DC}})-\Lodd(a_{\mathrm{DC}})\big)/n_{\mathrm{trial}}$ exactly as in Equation~\eqref{eq:logeuii}.
...
\begin{equation}\label{eq:app_ceiling_dc}
  \lim_{n_C\to\infty}\EUII^{\mathrm{DC}}_{\mathrm{avg}}(n_C)
